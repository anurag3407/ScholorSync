    ...
    'relative overflow-hidden rounded-md border shadow-lg text-sm',
    {
        variants: {
            variant: {
                ...
                teal:
                    'bg-gradient-to-r from-teal-50 to-emerald-50 border-teal-200 text-teal-900 dark:from-teal-900/20 dark:to-emerald-900/20 dark:border-teal-800 dark:text-teal-100',
            },
            size: {
